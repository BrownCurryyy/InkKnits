...
class Phase910Tests(unittest.TestCase):
    ...
    def test_atomization_materializes_lineage_versions_and_activity(self) -> None:
        ...
        with Session(engine) as session:
            ...
            station = Station(id=uuid4(), organization_id=organization.id, project_id=project.id, name="Writing", station_type="WRITING")
    ...
    def test_lineage_routes_respect_station_scope(self) -> None:
        ...
        with Session(engine) as session:
            ...
            station = Station(id=uuid4(), organization_id=org.id, project_id=project.id, name="Writing", station_type="WRITING")
