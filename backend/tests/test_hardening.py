...
class HardeningTests(unittest.TestCase):
    ...
    def test_station_access_requires_membership_unless_admin(self) -> None:
        ...
        with Session(engine) as session:
            ...
            assigned_station = Station(id=uuid.uuid4(), organization_id=organization_id, project_id=project.id, name="Writing")
            unassigned_station = Station(id=uuid.uuid4(), organization_id=organization_id, project_id=project.id, name="Image")
    ...
    def test_project_access_is_same_org_and_station_scoped(self) -> None:
        ...
        with Session(engine) as session:
            ...
            local_station = Station(id=uuid.uuid4(), organization_id=local_org.id, project_id=local_project.id, name="Writing")
