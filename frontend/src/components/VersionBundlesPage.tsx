...
export function VersionBundlesPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      {!bundles.length ? <CozyEmptyState icon="◇" title="Production state is not available" message="The project bundle will appear after the project has been initialized." /> : <>
